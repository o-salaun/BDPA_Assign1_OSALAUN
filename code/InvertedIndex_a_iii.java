...
public class InvertedIndex_a_iii extends Configured implements Tool { // put name of the class
   public static void main(String[] args) throws Exception {
      System.out.println(Arrays.toString(args));
      int res = ToolRunner.run(new Configuration(), new InvertedIndex_a_iii(), args);
   ...
   public int run(String[] args) throws Exception {
      System.out.println(Arrays.toString(args));
      Job job = new Job(getConf(), "InvertedIndex_a_iii");

      job.setJarByClass(InvertedIndex_a_iii.class);
