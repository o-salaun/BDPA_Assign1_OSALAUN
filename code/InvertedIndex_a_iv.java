...
import org.apache.hadoop.fs.FileSystem; // added for file system
...
public class InvertedIndex_a_iv extends Configured implements Tool {
   public static void main(String[] args) throws Exception {
      System.out.println(Arrays.toString(args));
      int res = ToolRunner.run(new Configuration(), new InvertedIndex_a_iv(), args);
   ...
   public int run(String[] args) throws Exception {
      System.out.println(Arrays.toString(args));
      Job job = new Job(getConf(), "InvertedIndex_a_iv");

      job.setJarByClass(InvertedIndex_a_iv.class);
      ...
      job.setNumReduceTasks(50); // use 50 reducers

      getConf().setBoolean(Job.MAP_OUTPUT_COMPRESS, true);
      getConf().setClass(Job.MAP_OUTPUT_COMPRESS_CODEC, BZip2Codec.class, CompressionCodec.class);
      // add compressor
