...
public class InvertedIndex_b extends Configured implements Tool { // put name of the class
   public static void main(String[] args) throws Exception {
      System.out.println(Arrays.toString(args));
      int res = ToolRunner.run(new Configuration(), new InvertedIndex_b(), args);
   ...
   public int run(String[] args) throws Exception {
      System.out.println(Arrays.toString(args));
      Job job = new Job(getConf(), "InvertedIndex_b");

      job.setJarByClass(InvertedIndex_b.class);
              ...
              throws IOException, InterruptedException {
                ...
                HashSet<String> stopwordslist = new HashSet<String>();
                  BufferedReader Reader = new BufferedReader(
                        new FileReader(new File("/home/cloudera/workspace/InvertedIndex_b/StopWords.csv"))); // input stopwords file
